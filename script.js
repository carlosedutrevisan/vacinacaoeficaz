...
function fazerCard(origem, destino) {
    ...
    const rodKm = 80; // velocidade media camihão
    const aerKm = 950; // velocidade media avião
    var tempoRod = (distanciaTotal / rodKm) * 197.28; // distancia em horas multiplicada pelo custo em horas
    var tempoAer = (distanciaTotal / aerKm) * 12309.45;
    ...
    var origemStrign =
        ...
        custoRodo.toFixed(2) +
        ' reais</strong> e o aeroviário é de <strong>' + custoAero.toFixed(2) + ' reais</strong>.</p>';
    // Testinho do card
    ...
    fazerMarkers(destino, verLugar(destino), distanciaTotal, custoRodo, custoAero);
}

function fazerMarkers(destinoCoords, destinoNome, distancia, custoRodo, custoAero) {
